...
type
  ...
  TEmployeeResource2 = class(TDataModule)
...
procedure TEmployeeResource2.Get(const AContext: TEndpointContext; const ARequest: TEndpointRequest; const AResponse: TEndpointResponse);
var
...
procedure Register;
begin
  RegisterResource(TypeInfo(TEmployeeResource2));
end;
