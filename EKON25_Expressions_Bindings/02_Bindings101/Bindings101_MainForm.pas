...
type
  TFormBindings = class(TForm)
    ...
    BindExpressionBevel21: TBindExpression;
    memoExpression: TMemo;
    LabelEval: TLabel;
    btnEval: TButton;
    Edit1: TEdit;
    Edit2: TEdit;
    BindExprItemsEdit11: TBindExprItems;
...
procedure TFormBindings.btnEvalClick(Sender: TObject);
var
  PureExprssion: TBindingExpression;
begin
  PureExprssion := TBindings.CreateExpression (
    [], {no input scopes}
    memoExpression.Lines.text);
  LabelEval.Caption := PureExprssion.Evaluate.GetValue.ToString;
end;
...
begin
  BindExpressionBevel21.Evaluate;
end;
